...
public class ThreadController {
	...
	/**
	 * Keep track of each thread by id
	 */
	ArrayList<ControllableThread> threadPool;
	
	/**
	 * Control cancel signal
	 */
	protected volatile boolean cancelSignal;
	...
	public ThreadController(Class _threadClass,
		...
		counter = 0;
		nThreads = 0;
		threadPool = new ArrayList<ControllableThread>(maxThreads);
		startThreads();
	}
